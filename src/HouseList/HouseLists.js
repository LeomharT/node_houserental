...
/**
 * @description 获取房源展示列表
 */
app.post("/GetHouseExhibitList", async (req, res) =>
{
...
/**
 * @description 获取房源详细信息
 */
app.get('/GetHouseDetailInfo', async (req, res) =>
{
    const conn = mysql.createConnection(AliDNS);
...
/**
 * @description 获取房源全景VR看房图片,信息点坐标
 */
app.get("/GetHouseVrSceneInfo", (req, res) =>
{
...
/**
 * @description 获取房源全景VR看房场景数目
 */
app.get("/GetHouseVrSceneArray", async (req, res) =>
{
    let reqObj = querystring.parse(req.url.split('?')[1]);
...
/**
 * @description 获取房源收藏状态
 */
app.get('/GetHouseCollectInfo', (req, res) =>
{
    const conn = mysql.createConnection(AliDNS);
    let reqObj = querystring.parse(req.url.split("?")[1]);
    const { id, hId } = reqObj;
 ...
 * @description 获取房源评论
 */
app.get("/GetHouseComment", (req, res) =>
{
    const conn = mysql.createConnection(AliDNS);
 ...
 * @description 发布房源评论
 */
app.post('/PostHouseComment', (req, res) =>
{
    const formData = new multiparty.Form();
    formData.parse(req, (err, fields, files) =>
    {
 ...
 * @description 获取房屋位置
 */
app.get('/GetAllHouseLocation', (req, res) =>
{
